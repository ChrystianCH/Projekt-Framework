                        ...
                        <div className="pure-u-1 pure-u-md-1-2">
                            <article className="blog-post">
                                <div className="blog-post-title">
                                    ...
                                    <span>
                                        <button className="action-button edit-button" onClick={() => handleEdit(item.id)}>&#x270E;</button>
                                        <button className="action-button delete-button" onClick={() => handleDelete(item.id)}>&#x2717;</button>
                                    </span>
                                </div>
