    ...
    return (
        <div className="new-post">
            <div className="new-post-header">
                <span>New Post</span>
                <button className="action-button delete-button" onClick={() => navigate(-1)}>&#10005;</button>
            </div>
            <form onSubmit={handleSubmit} className="new-post-form">
                <input placeholder="Title" name="title" onChange={handleChange} className="add-input"></input>
